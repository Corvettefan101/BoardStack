    ...
    try {
      ...
      if (signUpError) {
        ...
        toast({
          ...
          description: "Welcome to BoardStack. You can now start creating boards.",
        })
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">Join BoardStack and start organizing your projects</p>
          </CardHeader>
          <CardContent>
