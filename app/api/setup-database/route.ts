...
export async function POST(request: Request) {
  try {
    ...
    await supabaseAdmin.sql`
      ...
      -- Card Tags policies
      DROP POLICY IF EXISTS "Users can view card tags of accessible cards" ON card_tags;
      ...
      DROP POLICY IF EXISTS "Users can insert card tags to their cards" ON card_tags;
      ...
      DROP POLICY IF EXISTS "Users can delete card tags from their cards" ON card_tags;
